...
class Caller(Chain):
    ...
    def __init__(self, llm: BaseChatModel, api_spec: ReducedOpenAPISpec, scenario: str, requests_wrapper: RequestsWrapper, simple_parser: bool = False, with_response: bool = False) -> None:
